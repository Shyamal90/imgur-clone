...
const displayData = (data) => {
  ...
  data.map((item) => {
    ...
    //append in reaction
    reaction.append(likeDislike,comment);
    ...
    //append in section
    document.querySelector("section").append(cartContainer);
...
//       <div class="title">
//           <p>An FSB analysis of the situation in Ukraine</p>
//       </div>
//       <div class="reaction">
